# AiCommander v4.4.0-stable 发布分支
...
v4.3新增受控专题追问；本发布节点交付v4.4完整周期态势与真实覆盖方案比较。
实现工作包`41653a6`已完成连续五轮技术业务彩排；本分支等待最终合并发布，不以版本号替代Release状态。
共享代码中包含v4.5评测与运维准备，系列最终收口仍由独立v4.5发布确认；保留v3.6为升级回滚基线。
...
[v4.4发布说明](./docs/releases/v4.4.0-stable.md)。远端发布状态以GitHub Release为准，源码Stable不等于现场投产。
