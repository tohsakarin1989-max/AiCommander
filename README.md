...
v4.3新增受控专题追问；当前候选包含v4.4态势与覆盖比较、v4.5冻结评测及故障恢复能力。
本地实现工作包为`41653a6`，连续五轮技术业务彩排已通过；当前是候选版本，不是Stable发布。
保留v3.6为4.x升级回滚基线；分版本远端发布尚未收口，不以候选版本号替代发布状态。
...
[v4.5发布准备](./docs/releases/v4.5.0-stable.md)。远端发布状态以GitHub Release为准，源码Stable不等于现场投产。
