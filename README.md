...
v2.5 完整继承两个数据管家和双域融合研判，并新增统一 Agent 运行中心：按近 30 天汇总任务完成率、
...
当前 `v2.5.0-stable` 已通过后端 273 项、前端 22 个测试文件共 94 项测试、类型检查、生产构建、
依赖审计、全新数据库迁移、真实浏览器链路和隔离生产部署演练。完整结果、迁移版本和现场验收边界见
[v2.5.0-stable 发布说明](./docs/releases/v2.5.0-stable.md)。
