...
v2.2 新增地图数据管家指定人员试用、真实地图资源选择、试用指标和一键停用；停用会取消活动任务并使
待审批候选失效，但不触碰正式案件和地图数据。
...
当前 `v2.2.0-stable` 回归基线：后端 244 项测试、前端 19 个测试文件共 83 项测试通过。
