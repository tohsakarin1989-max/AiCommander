...
当前 `v2.8.0-stable` 已通过后端 296 项、前端 23 个测试文件共 100 项测试、类型检查、生产构建、
依赖审计、SQLite/PostgreSQL 全量迁移、真实浏览器工作台主链路，以及隔离生产部署和备份恢复演练。
最终迁移版本为 `a7d9e1f2b304`；目标服务器部署和至少 20 次真实业务效率样本仍属于现场验收项，完整边界见
[v2.8.0-stable 发布说明](./docs/releases/v2.8.0-stable.md)。
