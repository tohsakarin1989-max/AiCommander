...
当前 `v2.9.0-stable` 已通过后端 303 项、前端 24 个测试文件共 104 项测试、类型检查、生产构建、
生产依赖审计、SQLite/PostgreSQL 全量迁移、真实浏览器证据图谱主链路，以及隔离生产部署和备份恢复演练。
最终迁移版本仍为 `a7d9e1f2b304`；目标服务器部署、真实案件证据适用性和业务人员签字仍属于现场验收项，
完整边界见 [v2.9.0-stable 发布说明](./docs/releases/v2.9.0-stable.md)。
